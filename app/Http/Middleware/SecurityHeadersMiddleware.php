...
class SecurityHeadersMiddleware
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $csp = "default-src 'self'; " .
               ...
               "connect-src 'self' unpkg.com res.cloudinary.com *.cloudinary.com *.ngrok-free.app http://localhost:* https://localhost:* ws://localhost:* wss://localhost:* wss://*.ngrok-free.app; " .
