{{-- Document Builder - Preview Content (Optimized for Performance) --}}
<div class="w-full flex flex-col">
    ...
    <div x-show="activeTab === 'preview'" class="border rounded-lg min-h-[700px] bg-muted/30 relative flex flex-col items-center justify-start p-6 overflow-y-auto overflow-x-hidden">
        ...
        <div x-show="isGenerating || isLoadingPreview" class="absolute inset-0 bg-background/60 z-30 flex items-center justify-center rounded-xl" style="display: none;">
        ...
        <!-- Template Preview via iframe (Optimized Performance) -->
