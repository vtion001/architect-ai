                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-border hover:bg-muted/50">
                            ...
                            <td class="py-4 px-4 text-sm text-muted-foreground">{{ $doc['size'] }}</td>
                            <td class="py-4 px-4 text-sm">{{ $doc['category'] }}</td>
                            <td class="py-4 px-4 text-sm text-muted-foreground">{{ $doc['modified'] }}</td>
                            <td class="py-4 px-4">
