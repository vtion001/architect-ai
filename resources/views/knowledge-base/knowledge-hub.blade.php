                    ...
                    <div class="p-4 border border-border rounded-lg hover:bg-muted/50 cursor-pointer transition-colors">
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-muted-foreground">{{ $category['docs'] }} documents</p>
                            </div>
                        </div>
            ...
            <div class="p-6 pt-0">
                <div class="space-y-4">
                    ...
                    <div class="p-3 border border-border rounded-lg hover:bg-muted/50 cursor-pointer">
                        <h3 class="font-semibold text-sm mb-2">{{ $doc['title'] }}</h3>
                        <p class="text-xs text-muted-foreground mb-2">{{ $doc['category'] }}</p>
                        ...
                        <p class="text-xs text-muted-foreground">{{ $doc['updated'] }}</p>
                    </div>
                    @endforeach
                </div>
            </div>
