<?php $__env->startSection('title', 'Trend Analysis'); ?>
<?php $__env->startSection('container_class', 'minimal'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="report-header">
        ...
        <div class="report-meta">Future Outlook <?php echo e(date('Y')); ?></div>
        <?php if($recipientName): ?>
            <div style="margin-top: 20px; font-size: 1rem; color: #999; text-transform: none; letter-spacing: 0;">Prepared for <?php echo e($recipientName); ?></div>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('reports.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/reports/trend-analysis.blade.php ENDPATH**/ ?>