            ...
            <div x-show="generator !== 'video'" class="rounded-xl border border-border bg-card text-card-foreground shadow-sm">
                ...
                <div class="p-6 pt-0 mt-4">
                    <div class="space-y-4">
                        ...
                        <a href="<?php echo e(route('content-creator.show', $item)); ?>" class="block p-3 border border-border rounded-lg hover:bg-muted/50 transition-all">
                            <h3 class="font-semibold text-sm mb-2 line-clamp-1"><?php echo e($item->title); ?></h3>
                            ...
                            ?>
                            <span class="inline-flex items-center rounded-full border px-2.5 py-0.5 text-[10px] font-bold transition-colors uppercase tracking-wider <?php echo e($currentStatusClass); ?>">
