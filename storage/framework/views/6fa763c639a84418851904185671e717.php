...
<div class="p-8 max-w-7xl mx-auto" x-data="{ 
    ...
    prompt: <?php echo \Illuminate\Support\Js::from($selectedResearch?->title ?? '')->toHtml() ?>,
    sourceContent: '',
    researchTopic: <?php echo \Illuminate\Support\Js::from($selectedResearch?->title ?? '')->toHtml() ?>,
    isGenerating: false,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/report-builder/report-builder.blade.php ENDPATH**/ ?>