...
<div class="p-8 max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div class="rounded-xl border border-border bg-card text-card-foreground shadow-sm">
            <div class="p-4">
                <div class="w-10 h-10 <?php echo e($stat['color']); ?> rounded-lg flex items-center justify-center mb-3">
                    <span class="text-white font-semibold text-sm"><?php echo e(substr($stat['platform'], 0, 2)); ?></span>
                </div>
                <h3 class="font-semibold mb-1"><?php echo e($stat['platform']); ?></h3>
                <div class="flex items-center justify-between text-sm">
                    <span class="text-muted-foreground"><?php echo e($stat['posts']); ?> posts</span>
                    <span class="text-green-600 font-medium"><?php echo e($stat['engagement']); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-xl border border-border bg-card text-card-foreground shadow-sm">
            ...
            <div class="p-6 pt-0">
                ...
                <div class="grid grid-cols-7 gap-1 text-center text-sm">
                    <?php for($i = 0; $i < 3; $i++): ?> <div class="text-muted-foreground p-2 opacity-50"><?php echo e(29 + $i); ?></div> <?php endfor; ?>
                    <?php for($i = 1; $i <= 31; $i++): ?>
                        <div class="p-2 rounded-md hover:bg-muted cursor-pointer <?php echo e($i == 16 ? 'bg-primary text-primary-foreground hover:bg-primary' : ''); ?>">
                            <?php echo e($i); ?>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start gap-4 p-4 border border-border rounded-lg hover:bg-muted/50 transition-colors">
                        <div class="w-10 h-10 bg-muted rounded-lg flex items-center justify-center">
                            <i data-lucide="<?php echo e($post['icon']); ?>" class="w-5 h-5"></i>
                        </div>
                        <div class="flex-1">
                            <div class="flex items-center gap-2 mb-1">
                                <h3 class="font-semibold text-sm"><?php echo e($post['platform']); ?></h3>
                            ...
                            <p class="text-sm text-muted-foreground mb-2"><?php echo e($post['content']); ?></p>
