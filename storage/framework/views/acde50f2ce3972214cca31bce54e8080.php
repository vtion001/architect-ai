        ...
        <div class="rounded-xl border border-border bg-card text-card-foreground shadow-sm">
            <div class="p-4">
                ...
                <div class="flex items-center justify-between text-sm">
                    <span class="text-muted-foreground"><?php echo e($socialConfig['linkedin']['count'] ?? 0); ?> posts</span>
                    <span class="text-green-600 font-medium"><?php echo e($socialConfig['linkedin']['percentage'] ?? '0.0'); ?>%</span>
                </div>
            </div>
        </div>
        <div class="rounded-xl border border-border bg-card text-card-foreground shadow-sm">
            <div class="p-4">
                ...
                <div class="flex items-center justify-between text-sm">
                    <span class="text-muted-foreground"><?php echo e($socialConfig['twitter']['count'] ?? 0); ?> posts</span>
                    <span class="text-green-600 font-medium"><?php echo e($socialConfig['twitter']['percentage'] ?? '0.0'); ?>%</span>
                </div>
            </div>
        </div>
        <div class="rounded-xl border border-border bg-card text-card-foreground shadow-sm">
            <div class="p-4">
                ...
                <div class="flex items-center justify-between text-sm">
                    <span class="text-muted-foreground"><?php echo e($socialConfig['instagram']['count'] ?? 0); ?> posts</span>
                    <span class="text-green-600 font-medium"><?php echo e($socialConfig['instagram']['percentage'] ?? '0.0'); ?>%</span>
                </div>
            </div>
        </div>
        <div class="rounded-xl border border-border bg-card text-card-foreground shadow-sm">
            <div class="p-4">
                ...
                <div class="flex items-center justify-between text-sm">
                    <span class="text-muted-foreground"><?php echo e($socialConfig['facebook']['count'] ?? 0); ?> posts</span>
                    <span class="text-green-600 font-medium"><?php echo e($socialConfig['facebook']['percentage'] ?? '0.0'); ?>%</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="p-6 pt-0 max-h-[600px] overflow-y-auto">
                <div class="space-y-4">
                    <?php $__empty_1 = true; $__currentLoopData = $scheduledPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        ?>
                        <a href="<?php echo e(!empty($options['original_content_id']) ? route('content-creator.show', $options['original_content_id']) : '#'); ?>" 
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center justify-between mb-1">
                                    <div class="flex items-center gap-2">
                                        <h4 class="font-bold text-sm truncate"><?php echo e(ucfirst($platform)); ?> Post</h4>
                                        <span class="text-[9px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded border <?php echo e($post->status === 'published' ? 'text-green-700 bg-green-50 border-green-200' : 'text-purple-700 bg-purple-50 border-purple-200'); ?>">
                                            <?php echo e($post->status); ?>

                                        </span>
                                    </div>
                                    <span class="text-[10px] font-bold text-muted-foreground uppercase"><?php echo e($date->format('M d, g:i A')); ?></span>
                                </div>
                                <p class="text-xs text-muted-foreground line-clamp-2 mb-2 leading-relaxed"><?php echo e($post->result); ?></p>
...
<script>
    window.socialPlannerConfig = <?php echo \Illuminate\Support\Js::from($socialConfig)->toHtml() ?>;
    window.socialPlannerPosts = <?php echo \Illuminate\Support\Js::from($scheduledPosts)->toHtml() ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/social-planner/social-planner.blade.php ENDPATH**/ ?>