...
<div class="p-8 max-w-5xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        <div>
            <a href="<?php echo e(route('research-engine.index')); ?>" class="text-sm text-muted-foreground hover:text-foreground flex items-center gap-1 mb-2">
                <i data-lucide="arrow-left" class="w-4 h-4"></i>
                Back to Dashboard
            </a>
            <h1 class="text-3xl font-bold"><?php echo e($research->title); ?></h1>
            <p class="text-muted-foreground mt-1">Research Session Result • <?php echo e($research->created_at->format('M d, Y')); ?></p>
        </div>
        <div class="flex gap-2">
            ...
            <a href="<?php echo e(route('report-builder.index', ['research_id' => $research->id])); ?>" class="inline-flex items-center justify-center rounded-md text-sm font-medium bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2">
    ...
    <div class="grid grid-cols-3 gap-4 mb-8">
        <div class="p-4 rounded-xl border border-border bg-card">
            ...
            <p class="text-2xl font-bold text-blue-500"><?php echo e($research->sources_count); ?> Verified</p>
        </div>
        <div class="p-4 rounded-xl border border-border bg-card">
            <p class="text-xs text-muted-foreground uppercase tracking-wider font-semibold">Analyzed Depth</p>
            <p class="text-2xl font-bold text-green-500"><?php echo e($research->pages_count); ?> Pages</p>
        </div>
        <div class="p-4 rounded-xl border border-border bg-card">
    ...
    <div class="rounded-xl border border-border bg-card shadow-sm overflow-hidden">
        ...
        <div class="p-10 prose prose-slate max-w-none dark:prose-invert bg-white">
            <?php echo Str::markdown($research->result ?? 'No result data found.'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/research-engine/show.blade.php ENDPATH**/ ?>