...
<div class="p-8 max-w-5xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pb-20">
        ...
        <div x-data="{ 
            ...
            rawContent: <?php echo e(Js::from($finalPostContent)); ?>,
            htmlContent: <?php echo e(Js::from($cleanHtml)); ?>,
            ...
            handleUpload(event) {
                ...
                this.compressImage(file, (compressedBlob) => {
                    ...
                    fetch('<?php echo e(route('content-creator.upload-media')); ?>', {
                        method: 'POST',
                        body: formData,
                        headers: {
            ...
            generateImage() {
                ...
                fetch('<?php echo e(route('content-creator.generate-media')); ?>', {
                    method: 'POST',
                    headers: {
            ...
            regenerateText() {
                ...
                fetch('<?php echo e(route('content-creator.regenerate')); ?>', {
                    method: 'POST',
            ...
            confirmPublish() {
                ...
                fetch('<?php echo e(route('content-creator.publish')); ?>', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'Accept': 'application/json', 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' },
                    body: JSON.stringify({ 
                        content_id: <?php echo e($content->id); ?>,
        ...
        }" class="w-full bg-card border border-border rounded-xl shadow-md overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500" style="animation-delay: <?php echo e($index * 150); ?>ms;">
