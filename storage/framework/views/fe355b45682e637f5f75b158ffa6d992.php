        ...
        <div class="rounded-xl border border-border bg-card text-card-foreground shadow-sm">
            ...
            <div class="p-6 pt-0">
                <div class="space-y-4">
                    ...
                    <?php $__currentLoopData = $recentResearches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $research): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="p-4 border border-border rounded-lg hover:bg-muted/50 transition-colors">
                        ...
                        <div class="flex items-center gap-4 text-xs text-muted-foreground mb-3">
                            <span class="flex items-center gap-1">
                                ...
                                <?php echo e($research['sources']); ?> sources
                            </span>
                            <span class="flex items-center gap-1">
                                <i data-lucide="file-text" class="w-3 h-3"></i>
                                <?php echo e($research['pages']); ?> pages
                            </span>
                            <span><?php echo e($research['date']); ?></span>
                        </div>
